...
export default function AddPostScreen() {
  ...
  return (
    <View className="pl-10 pr-10 pt-16 bg-white flex-1">
      <KeyboardAvoidingView>
        <ScrollView>
          <Formik
            initialValues={{
              ...
              <TouchableWithoutFeedback onPress={() => Keyboard.dismiss()}>
                <View>
                  <View className="flex-row items-center gap-9">
                    <View>
                      <Text className="text-[5vw] text-center font-bold">
                        Add new post
                      </Text>
                      <Text className="text-[3vw] text-center text-gray-500 mb-8">
                    ...
                    <TouchableOpacity
                      ...
                      disabled={loading}
                      className="p-4 w-[40%] bg-black rounded-2xl mb-[3vh]"
                    >
                      {loading ? (
